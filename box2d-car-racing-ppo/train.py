...
def train(env, model, agent, device, n_episodes=3000, discount_factor=0.99):
    ...
    for episode in range(n_episodes):
        ...
        print(
            f"[Episode {episode + 1:4d}/{n_episodes}] Step = {step_cnt}, Loss = {loss:.5f}, ",
...
def main():
    ...
    env = EnvWrapper(gym.make("CarRacing-v3", domain_randomize=False), seed=seed)
